...
import type { EditableSectionShiftProps } from "@/components/editor/EditableSectionShift";

/** Editor-only section drag handle. */
export function EditableSectionShiftActive({
  settingKey,
  value = "0",
  children,
  className = "",
  ...
  const { saveSetting, saving, draftEpoch } = useEditor();
